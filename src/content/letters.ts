...
export const letterOne: LetterContent = {
  ...
  pages: [
    ...
    },
    {
      ...
      heading: 'photos',
      photoIds: ['photo-13', 'photo-14'],
      body: ['you might see these photos floating around hehe well idk if you will like it or not. but i thought it would be nice to have some of my favorite photos of my only favorite person in the letter. so i added them here. i mean there were alot of favs dangs but i cant put them all in here hehe, so like consider this like my favs from like a portion of the spams. i hab liek some 800 pics of you, lets say these are favs from liek 50 60 heheh. i love you !!'],
    },
    {
      id: 'letterOne-page-2',
    ...
    },
    {
      ...
      photoIds: ['photo-4', 'photo-5', 'photo-15'],
...
export const letterTwo: LetterContent = {
  ...
  pages: [
    ...
    },
    {
      ...
      photoIds: ['photo-8', 'photo-9', 'photo-16'],
      body: [
